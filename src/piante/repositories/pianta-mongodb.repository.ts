  ...
  async getPiantaById(id: number): Promise<PiantaInterface> {
    try {
      ...
      return {
        ...
        family: pianta.family,
        origin: pianta.origin,
        type: pianta.type,
        dimensions: pianta.dimensions,
        care_level: pianta.care_level,
        growth_rate: pianta.growth_rate,
        maintenance: pianta.maintenance,
        drought_tolerant: pianta.drought_tolerant,
        salt_tolerant: pianta.salt_tolerant,
        tropical: pianta.tropical,
        rare: pianta.rare,
        invasive: pianta.invasive,
        thorny: pianta.thorny,
        hardiness: pianta.hardiness,
        pruning_month: pianta.pruning_month,
        flowering_season: pianta.flowering_season,
        fruiting_season: pianta.fruiting_season,
        harvest_season: pianta.harvest_season,
        harvest_method: pianta.harvest_method,
        attracts: pianta.attracts,
        propagation: pianta.propagation,
        plant_anatomy: pianta.plant_anatomy,
        poisonous_to_humans: pianta.poisonous_to_humans,
        description: pianta.description,
        xWateringQuality: pianta.xWateringQuality,
        xWateringAvgVolumeRequirement: pianta.xWateringAvgVolumeRequirement,
        xWateringDepthRequirement: pianta.xWateringDepthRequirement,
        xWateringBasedTemperature: pianta.xWateringBasedTemperature,
        xWateringPhLevel: pianta.xWateringPhLevel,
        xSunlightDuration: pianta.xSunlightDuration,
      };
    } catch (error: unknown) {
